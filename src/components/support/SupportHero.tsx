    ...
    <section className="relative pt-16 md:pt-24 pb-12 md:pb-16 lg:pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted max-w-2xl mx-auto mb-6 md:mb-8 leading-relaxed font-medium">
        ...
        >
          ...
          <div className="relative">
            <input 
              ...
              className="w-full py-4 pl-12 pr-6 rounded-2xl bg-surface/50 backdrop-blur-xl border border-surface-border text-foreground placeholder:text-muted/60 focus:outline-none focus:border-primary/50 transition-all text-base shadow-2xl"
            />
            <svg className="w-5 h-5 text-primary absolute left-4 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute -bottom-4 -right-4 glass-card p-3 rounded-2xl shadow-xl hidden lg:block animate-float"
          >
