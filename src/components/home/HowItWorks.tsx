...
const HowItWorks = () => {
  return (
    <section className="py-8 bg-surface border-b border-navy/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-4">
          <span className="inline-block text-xs font-bold uppercase tracking-widest text-royal bg-primary/10 px-4 py-2 rounded-xl mb-4 border border-royal/20">
            Quick Start
          </span>
          <h2 className="text-lg md:text-xl font-black text-navy">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {steps.map((step, i) => (
            <div key={i} className="text-center">
              <div className="w-24 h-24 mx-auto mb-4 rounded-xl bg-primary/10 text-royal flex items-center justify-center text-base border border-navy/10 hover:bg-primary hover:text-white transition-all duration-300">
              ...
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-primary/10 text-royal border border-royal/20">
                {step.detail}
              </span>
            </div>
          ))}
