    ...
    <section className="py-8 bg-white border-b border-navy/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-4">
          ...
          <h2 className="text-lg md:text-base font-black text-navy">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {steps.map((step, i) => (
            <div key={i} className="text-center">
              <div className="w-24 h-24 mx-auto mb-4 rounded-xl bg-royal/10 text-royal flex items-center justify-center text-base border border-navy/10 hover:bg-royal hover:text-white transition-all duration-300">
