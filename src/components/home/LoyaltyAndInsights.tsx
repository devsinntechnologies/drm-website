            ...
            >
              ...
              <div className="relative space-y-4">
                ...
                <p className="text-slate-600 leading-7">
                  Designed for managers who need smart visuals, outlet
                  comparisons, and quick signals without the clutter.
                </p>
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={i}
                      className="rounded-3xl bg-white/90 px-4 py-3 text-sm text-slate-700 shadow-sm"
                    >
                      {item}
                    </div>
                  ))}
          ...
          {[
            {
              ...
              desc: "Stay aligned with revenue authorities.",
            },
            {
              title: "Scale faster",
              desc: "Prepare your business for franchise growth.",
            },
            {
              title: "Clear rules",
              desc: "Apply credit, payout, and ROI controls easily.",
            },
            {
              title: "Secure by design",
              desc: "Built with audit-ready workflows.",
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
