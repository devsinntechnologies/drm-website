...
const services = [
  {
    title: "MIS auditing",
    desc: "Clear reports and tracking that turn activity into actionable insights.",
  },
  {
    title: "System support",
    desc: "Round-the-clock help so POS and backend workflows stay reliable.",
  },
  {
    title: "Training",
    desc: "Practical training so your team gets the most from the platform.",
  },
  {
    title: "Inventory digitalization",
    desc: "Real-time stock, orders, and sales—full supply-chain visibility.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted mt-3 leading-relaxed max-w-xl">
            Support, training, and operational tooling that keep DigiNizam running with your team.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
          ...
          >
            <Image
              src="/whatwedo.jpg"
              alt="DigiNizam services and support"
              fill
