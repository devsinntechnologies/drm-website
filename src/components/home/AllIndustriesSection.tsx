...
export default function AllIndustriesSection() {
  const industries = [
    { name: "Retail Store", icon: "/retailstore.png", href: "/products/retail" },
    { name: "Pharmacy", icon: "/pharmacy.png", href: "/products/pharmacy" },
    { name: "Restaurant", icon: "/fastfood.png", href: "/products/restaurant" },
    { name: "Boutique", icon: "/boutique.png", href: "/products/apparel" },
    { name: "Salon / SPA", icon: "/beautysalon.png", href: "/products/salon" },
    { name: "Bakery POS", icon: "/bakeryshop.png", href: "/products/bakery" },
    { name: "Electric Store", icon: "/electricstore.png", href: "/products/electric" },
    { name: "Jewellery Shop", icon: "/jewelleryshop.png", href: "/products/jewellery" },
    { name: "Toys Store", icon: "/toys.png", href: "/products/toys" },
    { name: "Food / Cafe", icon: "/coffeeshop.png", href: "/products/cafe" },
    { name: "Furniture Store", icon: "/furniturestore.png", href: "/products/furniture" },
    { name: "Supermarkets", icon: "/supermarket.png", href: "/products/supermarket" },
    { name: "Manufacturing", icon: "/manufactoring.png", href: "/products/manufacturing" },
    { name: "Auto Parts", icon: "/AutoParts.png", href: "/products/automobile" },
