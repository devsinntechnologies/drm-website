  ...
  return (
    <section className="py-8 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-4 items-stretch max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="glass-card rounded-[32px] p-4 bg-surface/40 border-surface-border flex flex-col justify-between"
          >
            <div>
            ...
            <div className="mt-4 pt-6 border-t border-surface-border/50 text-center text-xs font-semibold text-muted tracking-widest uppercase">
          ...
          >
            ...
            <div className="mt-4 pt-6 border-t border-surface-border/50 text-center text-xs font-semibold text-primary tracking-widest uppercase">
