      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-24">
          <div className="flex-1 w-full relative">
            <div className="w-full rounded-2xl bg-surface border border-surface-border glass-card flex items-center justify-center overflow-hidden">
              <img src="/home/cloud-pos.png" alt="Cloud Based DRM System" className="w-full h-auto" />
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20 mb-24">
          <div className="flex-1 w-full relative">
            <div className="w-full rounded-2xl bg-surface border border-surface-border glass-card flex items-center justify-center overflow-hidden">
              <img src="/home/kds.png" alt="Kitchen Display Terminal" className="w-full h-auto" />
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 w-full relative">
            <div className="w-full rounded-2xl bg-surface border border-surface-border glass-card flex items-center justify-center overflow-hidden">
              <img src="/home/table-ordering.png" alt="Restaurant Table-Side Ordering" className="w-full h-auto" />
            </div>
          </div>
