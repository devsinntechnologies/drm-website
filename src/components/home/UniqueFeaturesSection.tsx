        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
          {usps.map((usp, idx) => (
            <motion.div
              ...
              className="glass-card bg-surface/40 border-surface-border p-6 rounded-2xl flex flex-col justify-between h-full hover:bg-surface hover:border-primary/30 transition-all duration-300 relative group"
              style={{
