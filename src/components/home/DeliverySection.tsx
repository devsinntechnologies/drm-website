      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-16 items-center">
          ...
          >
            ...
            <div className="relative glass-card rounded-[32px] border border-surface-border/90 bg-white p-6 shadow-2xl overflow-hidden">
              {/* Header */}
              ...
              <div className="w-full h-[220px] bg-background border border-surface-border rounded-2xl relative overflow-hidden mb-4">
                ...
                <div className="absolute top-[80px] left-[280px] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                  ...
                  <span className="text-[8px] font-black bg-white/95 px-2 py-0.5 border border-surface-border rounded-md mt-1 shadow-xs">Devsinn HQ</span>
                </div>
                ...
                <div className="absolute top-[180px] left-[400px] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                  ...
                  <span className="text-[8px] font-black bg-white/95 px-2 py-0.5 border border-surface-border rounded-md mt-1 shadow-xs">Guest (Oak St)</span>
                </div>
              </div>
