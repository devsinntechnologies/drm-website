...
const plans = [
  {
    ...
    price: "Free",
    period: "Forever",
    desc: "For small retail stores, cafes and new businesses getting started.",
  ...
  },
  {
    ...
    price: "Quote",
    period: "on demo",
    desc: "Advanced tools for growing retail stores and restaurants with multiple staff.",
  ...
  },
  {
    ...
    desc: "Full-scale solution for multi-location retail and restaurant businesses.",
