...
const plans = [
  {
    ...
    price: "Free",
    period: "Forever",
    desc: "For small businesses and single-location stores getting started.",
  ...
  },
  {
    ...
    price: "Quote",
    period: "on demo",
    desc: "Advanced tools for growing businesses with multiple staff, inventory and reporting needs.",
  ...
  },
  {
    ...
    desc: "Full-scale solution for multi-location businesses and growing chains.",
