        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-10 lg:gap-14">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Our mission is simple: we strive to make it easier for
              entrepreneurs around the world to do business, and help them take
              their restaurants, cafes, and bars to the next level with DRM.
            </p>
          </motion.div>
            ...
            >
              ...
              >
                ...
                {[
                  ...
                  <div
                    key={i}
                    className={`absolute ${pos} w-8 h-8 ${borders} border-primary/50 pointer-events-none z-10 transition-transform duration-500 rounded-sm group-hover:scale-110`}
                  />
                ))}
              </motion.div>
