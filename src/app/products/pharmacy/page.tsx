        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-4 items-center relative z-10">
          ...
          >
            ...
            <h2 className="text-base sm:text-lg font-black text-[#08162D] tracking-tight">
              Empower your <span className="text-[#0055FF]">pharmacy staff</span> with SRB
            </h2>
            ...
            >
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-gray-700 font-bold">
                <li className="flex items-center gap-3">
                  <FiCheckCircle className="text-[#0055FF]" size={18} /> Prescription &amp; Chemical Salt Search
                </li>
                <li className="flex items-center gap-3">
                  <FiCheckCircle className="text-[#0055FF]" size={18} /> Near-Expiry Stock Alerts &amp; Batch Locks
                </li>
                <li className="flex items-center gap-3">
                  <FiCheckCircle className="text-[#0055FF]" size={18} /> Automatic Tax Calculation &amp; FBR Compliant Invoicing
                </li>
              </ul>
            </motion.div>
