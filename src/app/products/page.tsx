...
import { FiShield, FiSmartphone, FiAward, FiCheckCircle, FiTrendingUp, FiServer, FiArrowRight } from "react-icons/fi";
    ...
    <main className="min-h-screen bg-white text-[#08162D]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full grid grid-cols-1 gap-12 items-center text-center">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black leading-tight mb-6 text-white tracking-tight">
              Advanced <span className="text-[#0055FF]">Supermarket</span> POS System
            </h1>
            <p className="text-sm md:text-base text-gray-300 font-normal leading-relaxed mb-8">
              Empower your hypermarket or retail store with lightning-fast barcode scanning, automated inventory restocking, multi-counter billing, and seamless daily reconciliation.
            </p>
      ...
      <section className="py-20 md:py-24 bg-white border-b border-gray-200 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center max-w-4xl relative z-10">
           <h2 className="text-2xl sm:text-4xl font-black text-[#08162D] mb-6 tracking-tight">Accelerate checkout speeds & minimize queues</h2>
           <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-8 font-normal">
             Handle high-volume customer traffic effortlessly with integrated electronic weighing scales, fast barcode lookups, and secure multi-tender payment processing.
           </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-[#08162D] mb-4 tracking-tight">
              Designed for Modern <span className="text-[#0055FF]">Retail Giants</span>
            </h2>
            <p className="text-gray-600 text-sm sm:text-base font-normal">
              Everything you need to run department stores, marts, and convenience stores with absolute precision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-lg font-black text-[#08162D] mb-3 group-hover:text-[#0055FF] transition-colors">Fast Barcode Scanning</h3>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed font-normal">
                High-speed item identification, multi-unit packaging support (pcs, pack, carton), and rapid counter checkout.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-black text-[#08162D] mb-3 group-hover:text-[#0055FF] transition-colors">Supplier & PO Management</h3>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed font-normal">
                Automated purchase orders, GRN processing, vendor ledger tracking, and stock return workflows.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed font-normal">
                Seamless digital invoice reporting and automated sales tax compliance tailored for Pakistani retail standards.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-[#08162D] mb-6 tracking-tight">
              Advanced Stock Auditing & <span className="text-[#0055FF]">Shrinkage Control</span>
            </h2>
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 font-normal">
              Keep track of thousands of SKU inventory items in real-time. Detect discrepancies, manage warehouse-to-shelf transfers, and eliminate inventory shrinkage completely.
            </p>
            <ul className="space-y-3 text-sm text-gray-700 font-bold">
              <li className="flex items-center gap-3">
                <FiCheckCircle className="text-[#0055FF]" size={18} /> Handheld Terminal Stock Auditing
              </li>
              <li className="flex items-center gap-3">
                <FiCheckCircle className="text-[#0055FF]" size={18} /> Automated Low-Stock Reorder Triggers
              </li>
              <li className="flex items-center gap-3">
                <FiCheckCircle className="text-[#0055FF]" size={18} /> Customer Loyalty Schemes & Gift Cards
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h4 className="text-lg font-black text-[#08162D]">Real-Time Business Insights</h4>
                <p className="text-xs text-gray-500 font-medium">Department-wise sales & profit tracking</p>
              </div>
            </div>
            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mb-6 italic font-normal">
              "Monitor cashier shift reports, fast-moving consumer goods (FMCG), and daily turnover margins instantly from your mobile or dashboard."
            </p>
